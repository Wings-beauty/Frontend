...
export const POPUP_PRODUCTS: PopupProduct[] = [
  {
    key: "kkotppang-fine-syrup-gloss-01-rose",
    brand: "꽃빵",
    name: "피네 시럽 글로스",
    shade: "1호 장미시럽",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["시럽 글로스", "촉촉한 발림", "화사한 레드"],
    reason: "장미빛 레드가 입술에 매끄러운 시럽 광택을 더해줘요.",
    priority: 1,
    imageUrl: `${IMG}/kkotppang-fine-syrup-gloss-01-rose.webp`,
    colorHex: "#c23b4a",
  },
  {
    key: "kkotppang-fine-blur-tint-01-confident",
    brand: "꽃빵",
    name: "피네 로즈 블러 틴트",
    shade: "1호 도도장미",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["블러 틴트", "매트한 마무리", "성숙한 로즈브라운"],
    reason: "깊이 있는 로즈 브라운이 성숙하고 도도한 무드를 완성해요.",
    priority: 2,
    imageUrl: `${IMG}/kkotppang-fine-blur-tint-01-confident.webp`,
    colorHex: "#9c4a5c",
  },
  {
    key: "kkotppang-fine-syrup-gloss-02-plum",
    brand: "꽃빵",
    name: "피네 시럽 글로스",
    shade: "2호 매화시럽",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["시럽 글로스", "촉촉한 발림", "발랄한 핑크"],
    reason: "화사한 핑크가 산뜻하게 발색되는 매화시럽 컬러예요.",
    priority: 3,
    imageUrl: `${IMG}/kkotppang-fine-syrup-gloss-02-plum.webp`,
    colorHex: "#e85c96",
  },
  {
    key: "kkotppang-fine-blur-tint-02-coy",
    brand: "꽃빵",
    name: "피네 로즈 블러 틴트",
    shade: "2호 새침장미",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["블러 틴트", "매트한 마무리", "차분한 더스티핑크"],
    reason: "차분한 더스티 핑크가 세련된 데일리 룩에 잘 어울려요.",
    priority: 4,
    imageUrl: `${IMG}/kkotppang-fine-blur-tint-02-coy.webp`,
    colorHex: "#c2687a",
  },
  {
    key: "kkotppang-fine-syrup-gloss-03-cherry",
    brand: "꽃빵",
    name: "피네 시럽 글로스",
    shade: "3호 벚꽃시럽",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["시럽 글로스", "촉촉한 발림", "은은한 파스텔"],
    reason: "은은한 벚꽃빛 핑크로 맑고 순수한 입술을 연출해요.",
    priority: 5,
    imageUrl: `${IMG}/kkotppang-fine-syrup-gloss-03-cherry.webp`,
    colorHex: "#f3a8b8",
  },
  {
    key: "kkotppang-fine-blur-tint-03-shy",
    brand: "꽃빵",
    name: "피네 로즈 블러 틴트",
    shade: "3호 수줍장미",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["블러 틴트", "매트한 마무리", "발그레한 로즈핑크"],
    reason: "발그레한 로즈 핑크가 수줍은 듯 자연스러운 혈색을 만들어요.",
    priority: 6,
    imageUrl: `${IMG}/kkotppang-fine-blur-tint-03-shy.webp`,
    colorHex: "#d94f6e",
  },
  {
    key: "kkotppang-fine-syrup-gloss-04-coral",
    brand: "꽃빵",
    name: "피네 시럽 글로스",
    shade: "4호 능소화시럽",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["시럽 글로스", "촉촉한 발림", "생기 코랄"],
    reason: "생기 있는 코랄 레드가 얼굴에 화사한 포인트를 줘요.",
    priority: 7,
    imageUrl: `${IMG}/kkotppang-fine-syrup-gloss-04-coral.webp`,
    colorHex: "#e8654f",
  },
  {
    key: "kkotppang-fine-blur-tint-04-fresh",
    brand: "꽃빵",
    name: "피네 로즈 블러 틴트",
    shade: "4호 상큼장미",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["블러 틴트", "매트한 마무리", "선명한 레드"],
    reason: "선명한 레드 톤이 상큼하고 생기 있는 인상을 줘요.",
    priority: 8,
    imageUrl: `${IMG}/kkotppang-fine-blur-tint-04-fresh.webp`,
    colorHex: "#c23838",
  },
  {
    key: "kkotppang-fine-syrup-gloss-05-tulip",
    brand: "꽃빵",
    name: "피네 시럽 글로스",
    shade: "5호 튤립시럽",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["시럽 글로스", "촉촉한 발림", "따뜻한 오렌지"],
    reason: "따뜻한 튤립빛 오렌지가 자연스러운 혈색을 더해줘요.",
    priority: 9,
    imageUrl: `${IMG}/kkotppang-fine-syrup-gloss-05-tulip.webp`,
    colorHex: "#f0916a",
  },
  {
    key: "kkotppang-fine-blur-tint-05-cozy",
    brand: "꽃빵",
    name: "피네 로즈 블러 틴트",
    shade: "5호 포근장미",
    category: "makeup",
    ...
    popupPrice: 10000,
    originalPrice: 13000,
    tags: ["블러 틴트", "매트한 마무리", "포근한 브라운로즈"],
    reason: "따뜻한 브라운 로즈가 포근하고 부드러운 무드를 더해요.",
    priority: 10,
    imageUrl: `${IMG}/kkotppang-fine-blur-tint-05-cozy.webp`,
    colorHex: "#c17858",
  },
  {
